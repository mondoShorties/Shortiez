myApp.controller('userStoryController',
['$scope', '$http', '$rootScope', '$location', 'userData', '$mdSidenav', '$uibModal', 'RatingFactory',
function ($scope, $http, $rootScope, $location, userData, $mdSidenav, $uibModal, RatingFactory) {
...
$scope.data = {
    ...
    $scope.rateStory = function(story, rate) {
      var data = {};
      data.story = story;
      data.rating = rate;
